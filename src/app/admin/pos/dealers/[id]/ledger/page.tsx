    ...
    <div className="p-10 max-w-7xl mx-auto space-y-10">
      <div className="flex justify-between items-end">
        <div>
           ...
           <p className="text-stone-500 font-bold mt-1">Bayi Bakiyesi ve İşlem Geçmişi</p>
        </div>
           ...
           <tbody className="text-sm font-bold divide-y divide-stone-100">
             {transactions.map(t => (
               <tr key={t.id} className="hover:bg-stone-50/50 transition">
                 ...
                 <td className="p-4">
                   <span className={`px-2 py-1 rounded-md text-[10px] uppercase tracking-wider ${t.type === 'DEBT' ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600'}`}>
