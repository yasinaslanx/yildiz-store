        ...
        ...(variants?.length ? {
          variants: {
            create: variants.map((v: any) => ({
              ...
              dealerPrice: v.dealerPrice ? new Prisma.Decimal(v.dealerPrice) : null,
              wholesalePrice: v.wholesalePrice ? new Prisma.Decimal(v.wholesalePrice) : null,
              retailPrice: v.retailPrice ? new Prisma.Decimal(v.retailPrice) : null,
              branchPrice: v.branchPrice ? new Prisma.Decimal(v.branchPrice) : null,
              buyPrice: v.buyPrice ? new Prisma.Decimal(v.buyPrice) : null,
              oldPrice: v.oldPrice ? new Prisma.Decimal(v.oldPrice) : null,
              stock: v.stock ?? 0,
              active: true,
            })),
          }
