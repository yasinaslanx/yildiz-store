...
async function run() {
  ...
  try {
    ...
    console.log(`Found ${variants.length} variants. Reverting prices...`);
    ...
    for (const v of variants) {
      ...
      if (done % 50 === 0) console.log(`Reverted ${done} / ${variants.length}`);
    }

    console.log("Done! All prices reverted successfully.");
  } finally {
